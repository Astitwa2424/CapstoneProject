...
export function BannerImageUpload({ value, onChange, disabled }: BannerImageUploadProps) {
  ...
  return (
    <div className="space-y-4">
      <Label className="text-base font-medium">Restaurant Banner Image</Label>
                ...
                <CardContent className="flex flex-col items-center justify-center p-8 text-center">
                  {isUploading ? (
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">Uploading banner image...</p>
                    </div>
                  ) : (
                    <>
                      <Upload className="h-8 w-8 text-muted-foreground mb-2" />
                      <p className="text-sm font-medium">Drop your banner image here</p>
                      <p className="text-xs text-muted-foreground mb-4">
                        or click to browse (Max 5MB, 1200x400px recommended)
                      </p>
